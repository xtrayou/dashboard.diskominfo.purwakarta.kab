    ...
    <div class="flex justify-between items-center">
        <div class="flex items-center space-x-4">
            ...
            <img src="<?php echo e(asset('images/logos/logo-diskominfo-purwakarta.jpg')); ?>"
                ...
                class="w-12 h-12 object-contain rounded-lg logo-static">
        ...
        <ul class="flex space-x-8 text-sm font-medium">
            <li>
                <a href="<?php echo e(route('dashboard')); ?>"
                    class="flex items-center space-x-2 <?php echo e(request()->routeIs('dashboard') ? 'text-blue-400 border-b-2 border-blue-400 pb-2' : 'text-gray-300 hover:text-white'); ?>">
            ...
            <li>
                <a href="<?php echo e(route('health.monitoring')); ?>"
                    class="flex items-center space-x-2 <?php echo e(request()->routeIs('health.monitoring') ? 'text-blue-400 border-b-2 border-blue-400 pb-2' : 'text-gray-300 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="<?php echo e(route('subdomain.status')); ?>"
                    class="flex items-center space-x-2 <?php echo e(request()->routeIs('subdomain.status') ? 'text-blue-400 border-b-2 border-blue-400 pb-2' : 'text-gray-300 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="<?php echo e(route('server.infrastructure')); ?>"
                    class="flex items-center space-x-2 <?php echo e(request()->routeIs('server.infrastructure') ? 'text-blue-400 border-b-2 border-blue-400 pb-2' : 'text-gray-300 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="<?php echo e(route('realtime.monitoring')); ?>"
                    class="flex items-center space-x-2 <?php echo e(request()->routeIs('realtime.monitoring') ? 'text-blue-400 border-b-2 border-blue-400 pb-2' : 'text-gray-300 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                    </svg>
