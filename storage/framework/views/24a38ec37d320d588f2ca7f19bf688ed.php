...
<div
    ...
    x-init="$watch('show', value => {
        if (value) {
            ...
            if (<?php echo e($attributes->has('focusable') ? 'true' : 'false'); ?>) {
...
<?php /**PATH C:\xampp\htdocs\DISKOMINFO\laravel\dashboard.diskominfo.purwakarta.kab\resources\views/components/modal.blade.php ENDPATH**/ ?>