                ...
                <div class="relative w-32 h-32 mx-auto mb-4">
                    <svg class="w-32 h-32 progress-ring">
                        ...
                        <circle cx="64" cy="64" r="56" stroke="#3b82f6" stroke-width="8" fill="transparent"
                            stroke-dasharray="351.86" stroke-dashoffset="{{ 351.86 - (351.86 * $serverStats['cpu_usage'] / 100) }}"
                            stroke-linecap="round" />
                    </svg>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-2xl font-bold text-gray-800">{{ $serverStats['cpu_usage'] }}%</span>
                    </div>
                </div>
                ...
                <div class="relative w-32 h-32 mx-auto mb-4">
                    <svg class="w-32 h-32 progress-ring">
                        ...
                        <circle cx="64" cy="64" r="56" stroke="#10b981" stroke-width="8" fill="transparent"
                            stroke-dasharray="351.86" stroke-dashoffset="{{ 351.86 - (351.86 * $serverStats['memory_usage'] / 100) }}"
                            stroke-linecap="round" />
                    </svg>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-2xl font-bold text-gray-800">{{ $serverStats['memory_usage'] }}%</span>
                    </div>
                </div>
                ...
                <div class="relative w-32 h-32 mx-auto mb-4">
                    <svg class="w-32 h-32 progress-ring">
                        ...
                        <circle cx="64" cy="64" r="56" stroke="#f59e0b" stroke-width="8" fill="transparent"
                            stroke-dasharray="351.86" stroke-dashoffset="{{ 351.86 - (351.86 * $serverStats['disk_usage'] / 100) }}"
                            stroke-linecap="round" />
                    </svg>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-2xl font-bold text-gray-800">{{ $serverStats['disk_usage'] }}%</span>
                    </div>
                </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-3 h-3 rounded-full mr-3 {{ $server['status'] === 'Online' ? 'bg-green-500' : 'bg-red-500' }}"></div>
                                    <div class="text-sm font-medium text-gray-900">{{ $server['name'] }}</div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $server['ip'] }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="text-sm text-gray-900">{{ $server['cpu'] }}%</div>
                                <div class="w-full bg-gray-200 rounded-full h-1.5 mt-1">
                                    <div class="bg-blue-500 h-1.5 rounded-full" style="width: {{ $server['cpu'] }}%"></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="text-sm text-gray-900">{{ $server['memory'] }}%</div>
                                <div class="w-full bg-gray-200 rounded-full h-1.5 mt-1">
                                    <div class="bg-green-500 h-1.5 rounded-full" style="width: {{ $server['memory'] }}%"></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">
                                {{ $server['status'] === 'Online' ? rand(1, 30) . ' days' : 'N/A' }}
                            </td>
