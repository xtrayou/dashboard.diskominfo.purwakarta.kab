            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white p-4 rounded-lg border text-center">
                        ...
                        <img id="testLogo1" src="{{ asset('images/logos/logo-diskominfo-icon.svg') }}"
                    ...
                    <div class="bg-blue-500 p-4 rounded-lg text-center">
                        ...
                        <img id="testLogo2" src="{{ asset('images/logos/logo-diskominfo-icon.svg') }}"
                            alt="Test Logo" class="mx-auto w-16 h-16 object-contain">
                    </div>
                    ...
                    <div class="bg-gray-800 p-4 rounded-lg text-center">
                        ...
                        <img id="testLogo3" src="{{ asset('images/logos/logo-diskominfo-icon.svg') }}"
                            alt="Test Logo" class="mx-auto w-16 h-16 object-contain">
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-green-400 to-blue-500 p-4 rounded-lg text-center">
                        ...
                        <img id="testLogo4" src="{{ asset('images/logos/logo-diskominfo-icon.svg') }}"
                            alt="Test Logo" class="mx-auto w-16 h-16 object-contain">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-white p-4 rounded-lg">
                        ...
                        <div class="mt-2 p-2 bg-blue-500 rounded">
                            <img src="{{ asset('images/logos/logo-diskominfo-icon.svg') }}"
            ...
            <div class="bg-green-50 rounded-lg p-6">
                ...
                <div class="mt-4 p-4 bg-blue-50 rounded-lg">
                    ...
                    <ul class="text-sm text-blue-700 space-y-1">
                        ...
                        <li>• <code>public/images/logos/logo-diskominfo-icon.svg</code> - Hanya icon untuk navbar</li>
